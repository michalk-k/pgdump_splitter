...
docker buildx build --push --no-cache --build-arg="APP_VERSION=v0.0.1" --build-arg="GO_VERSION=1.21" --platform "linux/amd64,darwin/arm64" --tag=$DOCKER_NAME:$APP_VERSION .
